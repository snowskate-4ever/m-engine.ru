...
class GenreSeeder extends Seeder
{
    ...
    public function run(): void
    {
        $genres = [
            ...
            ['name' => 'K-pop', 'description' => 'Korean popular music', 'sort_order' => 110],
            ['name' => 'J-pop', 'description' => 'Japanese popular music', 'sort_order' => 111],
            ['name' => 'Afrobeats', 'description' => 'Afrobeats', 'sort_order' => 112],
            ['name' => 'Латинский джаз', 'description' => 'Latin jazz', 'sort_order' => 113],
            ['name' => 'Фламенко', 'description' => 'Flamenco', 'sort_order' => 114],
            ['name' => 'Турецкий поп', 'description' => 'Turkish pop', 'sort_order' => 115],
            ['name' => 'Шансон', 'description' => 'Russian chanson', 'sort_order' => 116],
            ['name' => 'Авторская песня', 'description' => 'Singer-songwriter', 'sort_order' => 117],
            ['name' => 'Прог-рок', 'description' => 'Progressive rock', 'sort_order' => 118],
            ['name' => 'Пост-рок', 'description' => 'Post-rock', 'sort_order' => 119],
            ['name' => 'Шугейз', 'description' => 'Shoegaze', 'sort_order' => 120],
            ['name' => 'Грайм', 'description' => 'Grime', 'sort_order' => 121],
            ['name' => 'Lo-fi', 'description' => 'Lo-fi', 'sort_order' => 122],
        ];
