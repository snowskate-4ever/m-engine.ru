...
return new class extends Migration
{
    ...
    {
        // Гарантированно исправляем структуру таблицы socials
        $this->ensureCorrectSocialsStructure();
    }
    ...
    private function ensureCorrectSocialsStructure(): void
    {
        $columns = Schema::getColumnListing('socials');

        // Если таблица имеет правильную структуру, ничего не делаем
        $requiredColumns = ['id', 'link', 'socialable_id', 'socialable_type', 'type', 'name', 'description', 'sort_order', 'active'];
        $hasAllRequired = true;
