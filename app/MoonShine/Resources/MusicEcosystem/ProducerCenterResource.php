...
/**
 * @extends ModelResource<ProducerCenter>
 */
final class ProducerCenterResource extends ModelResource
{
    protected string $model = ProducerCenter::class;

    public function getTitle(): string
    {
        return 'Продюсерские центры';
    }
    ...
    public function rules(Model $item): array
    {
        ...
        return [
            ...
            'slug' => [
                ...
                'max:255',
                'regex:/^[a-z0-9]+(?:-[a-z0-9]+)*$/',
                Rule::unique('producer_centers', 'slug')->ignore($item->getKey()),
            ],
