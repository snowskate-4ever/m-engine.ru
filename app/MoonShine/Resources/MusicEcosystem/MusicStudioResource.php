...
/**
 * @extends ModelResource<Studio>
 */
final class MusicStudioResource extends ModelResource
{
    protected string $model = Studio::class;

    public function getTitle(): string
    {
        return 'Студии звукозаписи';
    }
    ...
    public function rules(Model $item): array
    {
        ...
        return [
            ...
            'slug' => [
                ...
                'max:255',
                'regex:/^[a-z0-9]+(?:-[a-z0-9]+)*$/',
                Rule::unique('studios', 'slug')->ignore($item->getKey()),
            ],
