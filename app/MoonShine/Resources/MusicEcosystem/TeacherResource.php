 ...
 */
final class TeacherResource extends ModelResource
{
    protected string $model = Teacher::class;

    public function getTitle(): string
    {
        return 'Преподаватели (публичный профиль)';
    }
    ...
    protected function formFields(): array
    {
        return [
            Box::make([
                ...
                Switcher::make('Другие города', 'available_other_cities')->default(false),
    ...
    public function rules(Model $item): array
    {
        ...
        return [
            ...
            'slug' => [
                ...
                'max:255',
                'regex:/^[a-z0-9]+(?:-[a-z0-9]+)*$/',
                Rule::unique('teachers', 'slug')->ignore($item->getKey()),
            ],
