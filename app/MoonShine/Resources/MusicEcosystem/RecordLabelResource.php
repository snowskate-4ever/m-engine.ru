...
/**
 * @extends ModelResource<RecordLabel>
 */
final class RecordLabelResource extends ModelResource
{
    protected string $model = RecordLabel::class;
    ...
    public function rules(Model $item): array
    {
        ...
        return [
            ...
            'slug' => [
                ...
                'max:255',
                'regex:/^[a-z0-9]+(?:-[a-z0-9]+)*$/',
                Rule::unique('record_labels', 'slug')->ignore($item->getKey()),
            ],
