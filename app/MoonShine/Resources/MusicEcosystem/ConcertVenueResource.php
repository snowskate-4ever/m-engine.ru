...
/**
 * @extends ModelResource<ConcertVenue>
 */
final class ConcertVenueResource extends ModelResource
{
    protected string $model = ConcertVenue::class;

    public function getTitle(): string
    {
        return 'Концертные площадки';
    }
    ...
    public function rules(Model $item): array
    {
        ...
        return [
            ...
            'slug' => [
                ...
                'max:255',
                'regex:/^[a-z0-9]+(?:-[a-z0-9]+)*$/',
                Rule::unique('concert_venues', 'slug')->ignore($item->getKey()),
            ],
