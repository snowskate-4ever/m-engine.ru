...
class PerformerCreate extends Component
{
    ...
    #[Validate('required|string|max:255|unique:peformers,name')]
    public string $name = '';
    ...
    public function save()
    {
        $this->validate([
            ...
            'name' => ['required', 'string', 'max:255', 'unique:peformers,name'],
            ...
            'name.unique' => 'Исполнитель с таким названием уже существует.',
    ...
    {
        return view('livewire.resource.performer-create');
    }
}
