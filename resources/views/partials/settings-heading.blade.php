    ...
    <div class="my-2">
        ...
        <div x-data="{ open: false }" @click.outside="open = false" class="inline-block">
            ...
            <div x-show="open" 
                ...
                <a href="profile" class="block px-4 py-2 text-sm text-gray-300 focus:bg-white/5 focus:text-white focus:outline-hidden">{{ __('ui.profile') }}</a>
                <a href="password" class="block px-4 py-2 text-sm text-gray-300 focus:bg-white/5 focus:text-white focus:outline-hidden">{{ __('ui.password') }}</a>
                <a href="two-factor" class="block px-4 py-2 text-sm text-gray-300 focus:bg-white/5 focus:text-white focus:outline-hidden">{{ __('ui.two-factor-auth') }}</a>
                <a href="appearance" class="block px-4 py-2 text-sm text-gray-300 focus:bg-white/5 focus:text-white focus:outline-hidden">{{ __('ui.appearance') }}</a>
            </div>
        </div>
        @endif
    </div>
