<div class="w-full max-w-xl space-y-6">
    ...
    <div class="rounded-xl border border-zinc-200 bg-white p-6 shadow-sm dark:border-zinc-700 dark:bg-zinc-800/80">
        <flux:heading size="md" class="mb-4">{{ __('ui.messenger.notifications_gateway_section') }}</flux:heading>
        <flux:checkbox wire:model.live="inAppEnabled" :label="__('ui.messenger.in_app_label')" />
        <flux:text class="mt-3 text-sm text-zinc-500">
            {{ __('ui.messenger.in_app_hint') }}
        </flux:text>
    </div>
